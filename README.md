...
客户提问转人工后，如果客服在 **10 秒**内还没有回复，网页会提示"人工客服正忙，留下你的電郵，客服稍後通過電郵回復您"，并在下方就地提供邮箱输入框，客户填写并提交后会立即发一封邮件通知客服（内容含客户邮箱、原始提问、对话编号），方便客服直接通过邮件回复；客户如果不填邮箱则不会触发这条邮件通知。整个过程网页仍会在后台继续轮询，一旦客服真正在网页端回复，会自动替换成实际内容，无需客户手动刷新。
